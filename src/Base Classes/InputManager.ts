  ...
  public setupDirections() {
    ...
    if (keys.left.isDown) {
      this.sprite.anims.play(
        this.sprite.getDirectionAnimationList()?.left ?? "left",
        true
      );
    } else if (keys.right.isDown) {
      this.sprite.anims.play(
        this.sprite.getDirectionAnimationList()?.right ?? "right",
        true
      );
    } else if (keys.up.isDown) {
      this.sprite.anims.play(
        this.sprite.getDirectionAnimationList()?.up ?? "up",
        true
      );
    } else if (keys.down.isDown) {
      this.sprite.anims.play(
        this.sprite.getDirectionAnimationList()?.down ?? "down",
        true
      );
    } else {
